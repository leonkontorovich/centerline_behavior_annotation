...
def make_skeleton(input_filename, h5_path):

    """
    Make an skeleton from binary image and h5_path with Head and Tail coordinates (DLC output)
    Parameters:
    -----------
    input_filename: str,
        Path to the input file
    h5_path: str
        Path to the h5 file with the head an tail coordinates file
    """
...
make_skeleton(input_filename, h5_path)