...
def main(arg_list=None):
    ...
    for i, image in enumerate(tif):
        ...
        head_coordinates = (int(round(head_y)), int(round(head_x)))
        tail_coordinates = (int(round(tail_y)), int(round(tail_x)))

        skel_points, K = place_skeleton_points_with_endpoints(skeleton_image, head_coordinates, tail_coordinates, num_points=args.number_of_spline)
