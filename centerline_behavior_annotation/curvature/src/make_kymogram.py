...
def main(arg_list=None):
    ...
    parser.add_argument('--spline_K', help='folder with the tracker position', required=True)
    parser.add_argument('--output_file', help='folder with the tracker position', required=True)

    args = parser.parse_args(arg_list)
    main_folder = args.input_path
    kymo_path = str(args.spline_K)
