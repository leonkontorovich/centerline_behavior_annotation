...
#This funciton should be import from the make_figure module
def plot_kymogram(kymo_path, smooth, axes):
    ...
    try:
        ...
        axes.imshow(df_kymo.T, origin="upper", cmap='seismic', extent=[0, df_kymo.shape[0], df_kymo.shape[1], 0],
                    aspect=20, vmin=-0.04, vmax=0.04)#aspect=5, vmin=-0.005, vmax=0.005)
...
paths = glob.glob("/Volumes/scratch/neurobiology/zimmer/ulises/wbfm/20221127/data/ZIM2165_Gcamp7b_worm1/2022-11-27_15-14_ZIM2165_worm1_GC7b_Ch0-BH/skeleton_spline_K_signed_avg.csv")
#print(paths)
smooth = False
for path in paths:
    print(path)
